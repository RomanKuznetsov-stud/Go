...
func main() {
	...
	//Оператор ! інвертує значення на протилежне.
	//Оператор && повертає true тільки тоді, коли обидві частини виразу є істинними. В усіх інших випадках результат буде false.
	//Оператор || повертає true, якщо хоча б одна частина виразу є істинною. Він повертає false лише тоді, коли обидві частини хибні.
